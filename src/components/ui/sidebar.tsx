...
function SidebarProvider({
  ...
  React.useEffect(() => {
    const defaultOpen = getCookie(SIDEBAR_COOKIE_NAME) === "true"
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden top-8! h-[calc(100dvh-2rem)]!"
          style={
            {
